...
function TriangleMark({ className }) {
  return (
    <svg className={className} viewBox="40 110 640 510" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
/**
 * variant: 'dark' — dark wordmark for light backgrounds (navbar)
 *          'light' — white wordmark for dark backgrounds (footer)
 */
export default function Logo({ variant = 'dark', tagline = true }) {
  return (
